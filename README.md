...
- **Auto-Trip Tracking (Bluetooth):** ระบบจับระยะทาง ผู้ใช้สามารถ "ผูก" รถที่สร้างไว้ในแอปกับ Bluetooth ของรถคันนั้น เมื่อขึ้นรถและเกิดการเชื่อมต่อ Bluetooth แอปจะเริ่มบันทึกการเดินทาง (Trip) และเก็บระยะทาง GPS อยู่เบื้องหลังทันที และจะสรุปทริปอัตโนมัติเมื่อลงจากรถ (Bluetooth ตัดการเชื่อมต่อ)
