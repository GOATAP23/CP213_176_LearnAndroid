...
- **☁️ Cloud Sync (Firebase / Supabase):** ปรับระบบจากการเซฟลงเครื่องเดี่ยวๆ (Local Storage) เป็นการสำรองข้อมูลขึ้น Cloud อัตโนมัติ เพื่อไม่ให้ข้อมูลประวัติรถสูญหายแม้มีการเปลี่ยนสมาร์ทโฟน
